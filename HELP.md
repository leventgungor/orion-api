...
* The original package name 'orion.orion-api' is invalid and this project uses 'orion.orionapi' instead.
...
```
$ docker run --rm -p 8080:8080 orion-api:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/orion-api
```
